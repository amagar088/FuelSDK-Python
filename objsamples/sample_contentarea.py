...
from MarketingCloudSDK.objects import ET_ContentArea, ET_CreateOptions, ET_DeleteOptions, ET_UpdateOptions
...
try:
    ...
    contentArea = ET_ContentArea()
    contentArea.auth_stub = myClient
    contentArea.props = {"CustomerKey": NameOfTestContentArea, "Name": NameOfTestContentArea}
